using System.Security.Cryptography; //nwm co to jest zjawiło się przy tworzeniu projekta
...
namespace Lab1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //zadanie 3 (łącznie z zadaniami 1, 2, 4, 5 oraz 6)
            switch (option)
            {
                case 1:
                    Odd_even_number();
